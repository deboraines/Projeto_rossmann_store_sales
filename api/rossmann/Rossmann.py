...
class Rossmann( object ):
    def __init__( self ):
        self.home_path = '/Users/deboragoncalves/Documents/repos/Data_science_em_producao/Projeto_rossmann_store_sales/'
    ...
    def get_prediction( self, model, original_data, test_data ):
        ...
        original_data['prediction'] = np.expm1( pred ) # fazer a re-escala de logaritmo para exponencial
